...
public class Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (usuario == null) {
			...
			response.sendRedirect("/ExemploServletsCookies/errorlogin.html");//Redireciona para html de erro!

		} else {
			Cookie cookie = new Cookie("usuario.logado", email);
			response.addCookie(cookie);
			response.sendRedirect("/ExemploServletsCookies/index.html"); //Redireciona para o html principal.
		}
